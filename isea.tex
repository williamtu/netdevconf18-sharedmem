...
%At high level: Share RX Queue or not
%Shared RX queue saves memory but fairness
%Not sharing uses too much memory
\subsection{A. Shared RXQ of PF}
% pros: assumption: not all send at the same time
...
\begin{figure}[t!]
\includegraphics[width=2.6in]{testbed.pdf}
\centering
\caption{}
\label{fig:testbed}
\end{figure}
